// components/categories/TechnologyCategory.jsx
...
const TechnologyCategory = ({
  ...
  const getValidImageUrl = (post) => {
    ...
    // Return fallback image for Technology category
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-gray-500">
            សូមរង់ចាំអត្ថបទថ្មីៗពីប្រភេទ {category?.name_kh || "បច្ចេកវិទ្យា"}
          </p>
          <Link
            to="/"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1518770660439-4636190af475?w=1920&h=500&fit=crop')",
        }}
      >
        ...
        <div className="relative container mx-auto px-4 py-16">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-blue-500/20 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-blue-400 text-sm">បច្ចេកវិទ្យាទំនើប</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">
              {category?.name_kh || "បច្ចេកវិទ្យា"}
            </h1>
            <p className="text-gray-200 max-w-xl">
              បច្ចេកវិទ្យាទំនើប AI, Robotics, Innovation
            </p>
        ...
        <div className="space-y-6">
          {posts.map((post, index) => {
            ...
            return (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                  <div className="md:w-1/3 h-56 md:h-auto relative overflow-hidden bg-gray-100">
                    <img
                      src={imageUrl}
                  ...
                  <div className="md:w-2/3 p-6 flex flex-col justify-center">
                    ...
                    <h3 className="font-bold text-xl text-gray-800 mb-2 group-hover:text-blue-600 transition line-clamp-2">
                      {post.title_kh}
                    </h3>
                    ...
                    <div className="mt-4 text-blue-600 text-sm font-medium inline-flex items-center gap-1 group-hover:gap-2 transition-all w-fit">
