...
//         {/* Row 1: Logo, Name, Search, Mobile Buttons */}
...
//           {/* Desktop Search - Row 1 */}
//           <form
//             onSubmit={handleSearch}
//             className="hidden lg:block relative ml-4 flex-shrink-0"
//           >
//             <input
//               type="text"
//               placeholder="ស្វែងរក..."
...
//               className="pl-10 pr-4 py-2 border rounded-xl w-64 xl:w-80 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
//             />
...
//         {/* Row 2: Navigation Links and Categories - Desktop */}
//         <div className="hidden lg:flex items-center gap-1 xl:gap-2 py-2 border-t border-gray-800 mt-1 overflow-x-auto">
//           <Link
//             to="/"
